...
// 测试环境启用vconsole
if (location.host.includes('http://wap1.caiyun.feixin.10086.cn')) {
    new Vconsole();
}
Vue.prototype.wx = wx;
...
Vue.prototype.isQQ = false;
var userAgent = navigator.userAgent.toLowerCase();
if (userAgent.match(/QQ\/[0-9]/i)){
  Vue.prototype.isQQ = true;
}
if (userAgent.match(/MicroMessenger/i) == "micromessenger") {
  Vue.prototype.isWeiXin = true;
  wx.miniProgram.getEnv( res => Vue.prototype.isMiniProgram = res.miniprogram);
}
